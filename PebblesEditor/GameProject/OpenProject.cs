...
namespace PebblesEditor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _appDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\PebblesEditor\";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Pebbles\Screenshot.png");
